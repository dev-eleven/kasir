          ...
          <div class="col-lg-12 col-xs-12">
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Data Product Returned</h3>
                <div class="box-tools">
                    ...
                    <table class="table table-hover no-margin">
                      ...
                      <?php 
                        ...
                        <tr>
                          ...
                          <td><?php echo date("D, d M Y",strtotime($key['date_back'])) ?></td>
                          <td>
                            <div class="input-group-btn">
                              <a href="<?php echo base_url('product_returned/update/').$key['id']?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                              <a href="<?php echo base_url('inventoriecontroller/product_returned_delete/').$key['id']?>" class="btn btn-danger" onclick="return doconfirm();"><i class="fa fa-trash"></i></a>
                            </div>
                          </td>
                        </tr>
                      <?php endforeach ?>
            ...
            <div class="modal-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" name="date_back" class="form-control" placeholder="Search date returned" id="datepicker">
                </div>
              </div>
            </div>
