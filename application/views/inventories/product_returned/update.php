                      ...
                      <div class="col-md-4">
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <input type="text" name="date_back" id="datepicker" class="form-control" value="<?php echo date('m/d/Y',strtotime($key['date_back'])) ?>">
                          </div>
                          <div class="col-md-6">
                            <label>Price</label>
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <div class="pull-right">
                        <a href="<?php echo base_url(); ?>product_returned" class="btn btn-default"><i class="fa fa-rotate-left"></i> Back</a>
