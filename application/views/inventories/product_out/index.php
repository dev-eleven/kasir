                        ...
                        <tr>
                          ...
                          <td>
                            <div class="input-group-btn">
                              ...
                              <a href="<?php echo base_url('inventoriecontroller/delete_product_out/').$key['id']?>" class="btn btn-danger" onclick="return doconfirm();"><i class="fa fa-trash"></i></a>
                            </div>
                          </td>
                        </tr>
                      <?php endforeach ?>
            ...
            <div class="modal-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" name="date_in" class="form-control" placeholder="Search date_out" id="datepicker">
                </div>
              </div>
            </div>
